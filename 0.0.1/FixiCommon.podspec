#
#  Be sure to run `pod spec lint FixiCommon.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Adam Lovastyik"
  # s.authors            = { "Adam Lovastyik" => "a.lovastyik@decos.com" }
  # s.social_media_url   = "http://twitter.com/nazabiker"
